                      ...
                      >
                        ...
                        <div className="bg-white py-6 px-5 xl:py-8">
                          ...
                          <span className="block pt-2 font-body text-grey-20">
                            {event.metadesc || "Click read more to view the full details of this event."}
                          </span>
                        </div>
                      </Link>
                    );
            ...
            <div className="relative bg-primary bg-cover bg-center bg-no-repeat py-16 bg-blend-multiply lg:py-24"
              ...
              <div className="container relative z-30">
                ...
                <form className="mt-6 flex flex-col justify-center sm:flex-row">
                  <input className="w-full rounded px-4 py-3 font-body text-white sm:w-2/5 sm:py-4 lg:w-1/3" type="text" id="email" placeholder="Give me your Email" />
                  <button

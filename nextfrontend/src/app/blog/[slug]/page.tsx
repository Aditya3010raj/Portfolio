...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params; // Handling dynamic route params for Next.js 15
  ...
  return (
    <>
      ...
      <div id="main" className="relative">
              ...
              <div className="mx-auto max-w-4xl">
                ...
                <div className="prose max-w-none pt-8">
                  ...
                  <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam
                    ...
                    consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est. Ut enim
        ...
        {/*<Navbar /> {/* Using the reusable Navbar with primary background 

          <div id="main" className="relative">
            <article className="min-h-screen bg-grey-50 pt-32 pb-20">
              <div className="container mx-auto px-4">
               
                <header className="mb-12 text-center">
                  <h1 className="font-header text-4xl font-bold text-primary uppercase sm:text-5xl lg:text-6xl mb-6">
                    {post.name}
                  </h1>
                ...
                <div className="prose lg:prose-xl mx-auto font-body text-grey-20 leading-relaxed prose-blue">
                ...
                <div className="flex flex-col items-center justify-center pt-16">
                  <p className="font-body text-lg font-semibold uppercase text-grey-20">Share this post</p>
                  <div className="flex items-center pt-4">
                    <a href="#" className="pl-4"><i className="bx bxl-facebook-square text-2xl text-primary hover:text-yellow"></i></a>
                    <a href="#" className="pl-4"><i className="bx bxl-twitter text-2xl text-primary hover:text-yellow"></i></a>
                    <a href="#" className="pl-4"><i className="bx bxl-linkedin text-2xl text-primary hover:text-yellow"></i></a>
                  </div>
                </div>
              </div>
            </article>
            ...
            <div className="bg-primary py-6">
              <div className="container flex flex-col justify-between sm:flex-row mx-auto text-center px-4">
                <p className="font-body text-white">© Copyright 2026. All right reserved, ATOM.</p>
              </div>
            </div>
          </div>
